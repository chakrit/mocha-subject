...
module.exports = (function() {
  ...
  // ### internal require shim
  // 
  // This is provided so user can override the source function to suit their code layout
  // structure or provide conveniences to shorten require strings. (i.e. auto-prefix
  // ../lib for require paths.)
  $S.require = require;
